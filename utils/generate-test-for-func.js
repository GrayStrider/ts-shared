...
const { funcName, fileName, should } = require('minimist')(process.argv.slice(2))

const testsFolder = './__tests__'
const testFile = testsFolder + `\\${fileName}.spec.ts`
const webstormPath = 'C:\\Users\\Ivan\\AppData\\Local\\JetBrains\\Toolbox\\apps\\WebStorm\\ch-0\\193.5233.80\\bin\\webstorm64.exe'
...
if (!fs.readFileSync(testFile, 'utf8')
  .includes(`expect(${funcName}`)) {
